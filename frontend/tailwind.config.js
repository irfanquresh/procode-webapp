  ...
  theme: {
    ...
    backgroundImage: ({ theme }) => ({
      ...
      "gradient-fuchsia":
        ...
        ")",
      "gradient-cyan":
        "linear-gradient(310deg," + theme("colors.blue.600") + "," + theme("colors.cyan.400") + ")",
      "gradient-orange":
        "linear-gradient(310deg," +
        ...
        ")",
      "gradient-red":
        "linear-gradient(310deg," + theme("colors.red.600") + "," + theme("colors.rose.400") + ")",
      "gradient-lime":
        "linear-gradient(310deg," +
      ...
      "gradient-dark-gray":
        ...
        ")",
      "gradient-gray":
        "linear-gradient(310deg," + theme("colors.gray.400") + "," + theme("colors.gray.100") + ")",

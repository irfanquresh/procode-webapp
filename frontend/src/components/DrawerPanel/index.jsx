...
const DrawerPanel = ({ title,show, onClose, children }) => {
  return (
    <>
                  ...
                  <Dialog.Panel className="pointer-events-auto relative w-screen max-w-xl">
                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                      <div className="px-4 sm:px-6">
                        <Dialog.Title className="text-xl text-gray-700">
                          {title}
                        </Dialog.Title>
                      </div>
                      <div className="relative mt-6 flex-1 px-4 sm:px-6 h-[95%] overflow-auto">
